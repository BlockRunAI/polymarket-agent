...
The x402 protocol solves this by making payments as simple as HTTP requests. BlockRun brings this to AI - <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> models, pay-per-request, no keys needed.
...
[BlockRun](https://blockrun.ai) is the gateway to AI services using x402 micropayments. Access <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> AI models with just a wallet - no API keys needed.
